import UserDomain, { AccessToken, RefreshToken } from "../../domains/user";
import API from "../api";

const endpoints = {
	tokenCreate: '/account/token/',
	tokenRefreshCreate: '/account/token/refres/',
	tokenVerifyCreate: '/account/token/verify/',
}
